    ...
    try:
        ...
        if not is_selected:
            ...
            background_image_path = download_image(
                "https://envs.sh/d2b.jpg", cppic_path
            )
            ...
            TXT = f"""
**Oɴʟʏ Cᴏᴜᴘʟᴇꜱ Hᴇʀᴇ Aʀᴇ.:

@Sahil_x_Official + @meerab_jee = 💚😘😽

      Nᴏ Mᴏʀᴇ Cᴏᴜᴘʟᴇ Sᴇʟᴇᴄᴛɪᴏɴ Aɴʏᴍᴏʀᴇ!**
            """
